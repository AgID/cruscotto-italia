#!/usr/bin/env bash
# Pa11y test della sezione "Meteo" (tab Meteo e Aria) su 4 comuni.
set -uo pipefail
...
CONFIG_FILE="$(mktemp --suffix=.json /tmp/pa11y-meteo-config.XXXXXX)"
...
FAILED=0
echo "======================================================================"
echo "Pa11y test sezione Meteo (tab Meteo e Aria) - standard: $STANDARD"
