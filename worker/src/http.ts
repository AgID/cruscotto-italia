...
<main class="mcp-page">
  ...
  <div class="tools">
    <div class="tool-row"><div class="tool-name">mcp_info</div><div class="tool-desc">Metadata del server: versione, sorgenti integrate (24), freshness di ogni dataset.</div></div>
...
export async function handleHealth(_req: Request, env: Env): Promise<Response> {
  ...
  const status = { service: "cruscotto-italia-mcp", version: "0.15.0", r2: r2Ok, kv: kvOk, timestamp: new Date().toISOString() };
