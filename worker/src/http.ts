...
<main class="mcp-page">
  ...
  <p><a href="https://cruscotto-italia.dati.gov.it/data/skills/cruscotto-italia-workflow-v2.4.4.zip" download><strong>cruscotto-italia-workflow-v2.4.4.zip</strong></a></p>
  ...
  <div class="tools">
    <div class="tool-row"><div class="tool-name">mcp_info</div><div class="tool-desc">Metadata del server: versione, sorgenti integrate (26), freshness di ogni dataset.</div></div>
