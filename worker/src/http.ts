...
<div class="mini-mast">
  <div class="wrap">
    <div class="mini-brand-wrap">
      ...
      <span class="mini-brand-sub">MCP Server · 19 fonti istituzionali</span>
    </div>
  </div>
</div>
...
<main class="mcp-page">
  ...
  <div class="tools">
    ...
    <div class="tool-row"><div class="tool-name">comune_kpi</div><div class="tool-desc"><strong>Primo tool da chiamare per query puntuali e confronti.</strong> ~55 KPI sintetici di un comune in risposta leggera (~2.5KB / ~620 token). 22 gruppi tematici: anagrafica, demografia, istruzione, lavoro, redditi MEF, scuole MIUR, contratti ANAC, opere BDAP, PNRR, spese SIOPE, patrimonio PA, ambiente, qualità aria, turismo, veicoli ACI, banda larga AGCOM, ricarica EV, carburanti MIMIT, civici ANNCSU, Terzo Settore RUNTS, sanità. Importi finanziari anche in euro per abitante per facilitare confronti. Usa questo per: <em>"popolazione di Bari"</em>, <em>"Verona vs Bari su PNRR"</em>, <em>"top comuni per banda larga"</em>. Per dettagli (mappe, top liste, time series) chiama <code>comune_dashboard</code>.</div></div>
    <div class="tool-row"><div class="tool-name">comune_dashboard</div><div class="tool-desc"><strong>Vista dettagliata singolo comune</strong> (~250K token). Stesso ambito di <code>comune_kpi</code> ma include array completi: top categorie merceologiche ANAC, settori BDAP, missioni PNRR, piramide età demografia, time series SIOPE mensili, mappa civici ANNCSU, punti ricarica EV, stabilimenti ospedalieri con discipline. Sezioni complete: anagrafica, demografia (POSAS), profilo (Censimento ISTAT), turismo, PNRR, territorio (ISPRA Suolo, IdroGEO, Rifiuti), aria (ISPRA SNPA: PM10/PM2.5/NO2), opere pubbliche (BDAP-MOP), contratti ANAC aggregati, spese SIOPE multi-anno, scuole (MIUR), veicoli e incidenti (ISTAT + ACI), redditi e fisco (MEF IRPEF), patrimonio immobiliare PA (MEF DE), ANNCSU (civici e strade Agenzia Entrate), sanita' territoriale (Ministero Salute), punti di ricarica veicoli elettrici (GSE/MASE PUN), copertura banda larga (AGCOM Broadband Map), distributori carburanti e prezzi (MIMIT Osservatorio Prezzi), enti del Terzo Settore (Min. Lavoro RUNTS - ODV/APS/EF/IS/SMS/ETS).</div></div>
    <div class="tool-row"><div class="tool-name">comune_opere_dettaglio</div><div class="tool-desc">Lista completa delle opere pubbliche BDAP-MOP del comune con CUP, costi, finanziamenti, stato. Filtrato al 2025 (data inizio &gt;= 2025-01-01 OPPURE stato ATTIVO). Non disponibile come dato aggregato in <code>comune_dashboard.bdap_kpi</code>.</div></div>
