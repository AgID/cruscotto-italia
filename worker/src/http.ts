...
<main class="mcp-page">
  ...
  <p><a href="https://cruscotto-italia.dati.gov.it/data/skills/cruscotto-italia-workflow-v2.9.1.zip" download><strong>cruscotto-italia-workflow-v2.9.1.zip</strong></a> &mdash; <em>skill</em> versione 2.9.1 del 05/08/2026</p>
...
export async function handleHealth(_req: Request, env: Env): Promise<Response> {
  ...
  const status = { service: "cruscotto-italia-mcp", version: "0.18.0", r2: r2Ok, kv: kvOk, timestamp: new Date().toISOString() };
