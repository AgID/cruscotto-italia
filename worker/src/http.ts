...
<main class="mcp-page">
  ...
  <div class="tools">
    <div class="tool-row"><div class="tool-name">mcp_info</div><div class="tool-desc">Metadata del server: versione, sorgenti integrate (25), freshness di ogni dataset.</div></div>
